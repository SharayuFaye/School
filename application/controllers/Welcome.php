...
class Welcome extends CI_Controller {
        ...
        if($this->input->post('login')){
            ...
            if($data == 'False'){
                ...
                for($i=1;$i<=date('m');$i++){
                       ...
                       $attendances_percent_present = count($this->m_attendances->attendances_percent_present($i)); 
                    if($attendances_count > 0){
                        $this->data['attendances_count'][$i] = round( ($attendances_percent_present / $attendances_count )*100 ); 
                    }else{
    ...
    public function timetable_sections_fetch()
    {
        $class_sel = $this->input->get('class_sel') ;
...
//         print_r($this->data['leaves_student_show']);exit();
    ...
    public function timetables_add()
    {
        ...
        //print_r($this->data['class_show']);exit();
        //$this->data['class_show'] =$this->m_class->class_show_id();
        $this->data['teachers_show'] =$this->m_teachers->teachers_show_id();
        $this->data['sections_distinct'] =$this->m_sections->sections_distinct();
        $this->data['sections_show'] =$this->m_sections->sections_show_id();
